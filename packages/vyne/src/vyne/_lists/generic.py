...
from vyne._lists.source import KeyRegistry


# ---------------------------------------------------------------------------
# Shared key/alignment helpers (inlined into the generic engine)
# ---------------------------------------------------------------------------
...
class VirtualListSpec:
    ...
    def __post_init__(self) -> None:
        if not isinstance(self.source, VirtualData):
            raise TypeError("source must implement VirtualData")
...
def _source_identity(source: VirtualData) -> Any:
